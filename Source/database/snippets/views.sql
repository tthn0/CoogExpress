...
FROM user AS u, address AS a, employee AS e, employee AS s, user AS su
WHERE u.id = e.user_id AND u.address_id = a.id AND e.supervisor_employee_id = s.id AND s.user_id = su.id;
