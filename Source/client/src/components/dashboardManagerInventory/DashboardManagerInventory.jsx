...
import styles from "./DashboardManagerInventory.module.scss";

const DashboardManagerInventory = () => {
          ...
          <ul>
            {inventory.map((inv) => (
              <li key={inv.id} className={styles.inventoryItem}>
                ...
                <p>
                  <strong>Product ID:</strong> {inv.product_id}
                </p>
                <p>
                  <strong>Current Stock:</strong> {inv.quantity_in_stock}
                </p>
                <p>
                  <strong>Stock Alert:</strong> {inv.stock_alert_threshold}
                </p>
                <p>
                  <strong>Last Stock Update:</strong> {inv.last_stock_update}
                </p>
                <input
                  value={inv.newStock}
                  onChange={(event) => {
                  ...
                  maxLength="5"
                />
                <button onClick={onButtonClick}>Add Stock</button>
              </li>
            ))}
          </ul>
        </div>
...
export default DashboardManagerInventory;
